        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default" style="width:100; over-flow:hidden;">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn-group w-100">
                                  <a href="{{route('academic.cheque.payment')}}" class="btn btn-light col fileinput-button">
                                    <!--<i class="fa-solid fa-circle-check text-success"></i>-->
                                    <span>Academic Cheque Status</span>
                                  </a>
                                  <a href="{{route('transport.cheque.payment')}}" class="btn btn-info col cancel">
                                    <!--<i class="fas fa-times-circle text-danger"></i>-->
                                    <span>Transport Cheque Status</span>
                                  </a>
                                </div>
                              </div>
                        </div>
                    ...
                    <div class="mx-3 my-2">
                        <h4>Academic Cheque Status List</h4>
                    </div>
