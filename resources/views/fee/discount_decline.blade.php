                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn-group w-100">
                                  <a href="{{route('fee.discount.decline')}}" class="btn btn-light col fileinput-button">
                                    <!--<i class="fa-solid fa-circle-check text-success"></i>-->
                                    <span>Discount Declined</span>
                                  </a>
                                  <a href="{{route('fee.discount.history')}}" class="btn btn-info col cancel">
