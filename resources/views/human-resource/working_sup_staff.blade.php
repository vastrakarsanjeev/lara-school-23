        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default" style="width:100; over-flow:hidden;">
                    <div class="card-header row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="btn-group w-100">
                                        <a href="{{route('human.working.official.staff')}}"
                                            class="btn btn-info col fileinput-button">
                                            <!--<i class="fa-solid fa-circle-check text-success"></i>-->
                                            <span>Official Staff</span>
                                        </a>
                                        <a href="{{route('human.working.suport.staff')}}"
                                            class="btn btn-light col cancel">
                                            <!--<i class="fas fa-times-circle text-danger"></i>-->
                                            <span>Suport Staff</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="btn-group w-100">
                                        <a href="{{route('human.ex.official.staff')}}"
                                            class="btn btn-primary col fileinput-button">
                                            <!--<i class="fa-solid fa-circle-check text-success"></i>-->
                                            <span>Official Staff</span>
                                        </a>
                                        <a href="{{route('human.ex.suport.staff')}}"
                    ...
                    <div class="mx-3 my-2">
                        <h4>Working Suport Staff List</h4>
                    </div>
