...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/js/bootstrap-duallistbox.min.css') }}">
    <!-- BS Stepper -->
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/topstyle.css') }}">
<style>
.navbar-badge {
    font-size: 0.8rem;
    font-weight: 300;
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        <span class="" style="font-size:1.3rem;">Session: {{getAcademicSession()}}</span>
                ...
                <li class="nav-item dropdown mx-2">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        ...
                        <span class="badge badge-info navbar-badge">Super-Admin</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="../../index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Brilliant Public School</span>
            </a>
              ...
              <li class="nav-item">
                <a href="../../index3.html" class="nav-link">
                  ...
                  <p>Dashboard v3</p>
                        ...
                        <li class="nav-item">
                            <a href="{{route('show.privilege')}}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{route('ass.pri.working.employee')}}" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Assign Privellege
                                    <!--<span class="right badge badge-danger">New</span>-->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('admission.enquiry')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Enquiry Form</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('admission.view.enquiry')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View Enquiry</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('admission.enquiry.approval.details')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Enquiry Approval</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('master.section')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Section Master</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('master.library.rule')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Library Rule Master</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('master.salary.calculation')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Salary Calculation Master</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('master.add.subject.to.class')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Subject Class Assign Master</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('master.empolyee.salary')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Amployee Salary Master</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('master.house')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>House Master</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('master.create_activity')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create Activity</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('master.fee')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Free Master</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{route('master.department')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Department Master</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('master.class')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Class Master</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('master.discount_coupon')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Discount Coupon Master</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('master.create.subject')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create Subject</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('master.leave')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Leave Master</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('master.session')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Session Master</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create Auto Time Table</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View Time Table(Class-Wise)</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View Time Table(Teacher-Wise)</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Update Time Table</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Delete Time Table</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Employee Hiring Report</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Official Employee Salary Report</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Official Employee Leave Report</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Employee Year Of Servic Record</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Employee Anniversary Report</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Employee Amergency Contact Report</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Employee CTC Report</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Employee Re-Hiring Report</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Employee Advance Loan Report</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Employee Pf Loan Report</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>House Assign Form</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View Student House</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create House Mentor</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Club Activity Assign Teacher</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Club Activity Assign Student</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Club Wise Student</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
    ...
    <script src="{{ asset('assets/js/topstyle.js') }}"></script>
